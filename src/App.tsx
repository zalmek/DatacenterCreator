...
function App() {
    const [_, setPath] = useState(["Главная"])
    ...
    const [Components, setComponents] = useState([
        {
            ...
            "componentprice": 4199,
            "componentimage": "/DatacenterCreator/72daa4a1199c44c41105cadc0fc6ab447b24a918f15c6e32cbf0134027a963e6.jpg",
        ...
        },
        {
            ...
            "componentimage": "/DatacenterCreator/08ea41bbc0ac10de581b7ea3edf070d5e292f151ee805ef6f2dd5a12addbaa43.jpg",
        ...
        },
        {
            ...
            "componentprice": 9499,
            "componentimage": "/DatacenterCreator/879dd5ff8210e347cffc72bdd14e492278c55e5d0eceac511fac9abbe75ebc78.jpg",
    ...
    const executeSearch = (filter: string) => {
        const newpath = `/?filterText=${filter}`
        axios.get(BASE_URL + "?filterText=" + filter).then(response => setComponents(response.data.components))
        setComponents(prevState => prevState.filter((component) => component.componentname.includes(filter)))
        navigate(newpath)
    }
  ...
  return (
      <>
          ...
          <ComponentsGrid components={Components} goToInfoPage={goToInfoPage} Filter={[Filter, setFilter]} changeFilter={changeFilter}
